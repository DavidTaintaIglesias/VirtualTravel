package com.vitualtravel.shared.exceptions;
...
public class CustomizedResponseEntityExceptionHandler {
    ...
    //Añadir excepcion de los enum
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    @ExceptionHandler(HttpMessageNotReadableException.class)
    public ResponseEntity<ErrorMessage> HttpMessageNotReadableException(HttpMessageNotReadableException ex) {
        ErrorMessage customError = new ErrorMessage(new Date(), "Incorrect city or hour", HttpStatus.UNPROCESSABLE_ENTITY.value());
        return new ResponseEntity<ErrorMessage>(customError, HttpStatus.UNPROCESSABLE_ENTITY);
    }
}
